...
public class IndexServlet extends HttpServlet {
	...
	/*
	 * public IndexServlet() { //in de constructor kunnen gegevens meegegeven
	 * worden aan de servlet adres.setStraat("Diestsesteenweg");
	 * adres.setHuisNr("622"); Gemeente gemeente = new Gemeente();
	 * gemeente.setPostcode(3010); gemeente.setNaam("Kessel-lo");
	 ...
	 *      response) setAttribute geeft gegevens door aan de webpagina
	 */
	@Override
